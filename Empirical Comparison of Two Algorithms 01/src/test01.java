...
public class test01 {
	...
	public static int[] randomArray(){ 
		...
		for (int j = 0; j < result.length; j++) {
			result[j] = /*Math.abs(*/r.nextInt(/*) % (max-min*/100)+1/*)*//* + min*/;
		}  
		Arrays.sort(result);
	    return result;  
	}
	...
	public static void main(String[] args) {
		...
		int A[] = randomArray();
		//System.out.println("The median of the input/random aray is " + BruteForceMedian(A));
		System.out.println("Median of the array: " + BruteForceMedian(A));
		printInfo(A);
